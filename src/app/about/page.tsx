      ...
      <div className="container mx-auto px-4 max-w-4xl relative">
        ...
        <div className="bg-white rounded-xl shadow-2xl p-8 mb-8 border-8 border-blue-700 relative">
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-6">
            <div className="bg-blue-100 p-6 rounded-lg border-4 border-blue-600 shadow-lg">
            ...
            <div className="bg-green-100 p-6 rounded-lg border-4 border-green-600 shadow-lg">
              <h3 className="font-bold text-green-900 mb-2 text-xl">♣ Team Play</h3>
              <p className="text-gray-900 font-medium">
                Success requires coordination with your partner. Learn to read signals and work together to achieve your goals.
              </p>
            </div>
            <div className="bg-red-100 p-6 rounded-lg border-4 border-red-600 shadow-lg">
        ...
        <div className="bg-white rounded-xl shadow-2xl p-8 mb-8 border-8 border-green-700 relative">
          {/* Decorative corners */}
          <div className="absolute top-0 left-0 w-12 h-12 border-t-4 border-l-4 border-blue-600 rounded-tl-xl"></div>
          <div className="absolute top-0 right-0 w-12 h-12 border-t-4 border-r-4 border-red-600 rounded-tr-xl"></div>
          <div className="absolute bottom-0 left-0 w-12 h-12 border-b-4 border-l-4 border-red-600 rounded-bl-xl"></div>
          ...
          <div className="space-y-6">
            <div className="flex items-start bg-blue-50 p-6 rounded-lg border-4 border-blue-600 shadow-lg">
              <div className="bg-blue-600 rounded-full p-3 mr-4 mt-1 shadow-md">
            ...
            <div className="flex items-start bg-green-50 p-6 rounded-lg border-4 border-green-600 shadow-lg">
              <div className="bg-green-600 rounded-full p-3 mr-4 mt-1 shadow-md">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              <div>
                <h3 className="font-bold text-green-900 mb-2 text-xl">Comprehensive Learning Resources</h3>
            ...
            <div className="flex items-start bg-red-50 p-6 rounded-lg border-4 border-red-600 shadow-lg">
              <div className="bg-red-600 rounded-full p-3 mr-4 mt-1 shadow-md">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-gradient-to-r from-red-700 via-blue-700 to-green-700 rounded-xl shadow-2xl p-10 text-white text-center border-4 border-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/auth/signup"
              className="bg-white text-red-700 px-8 py-4 rounded-lg text-lg font-bold hover:bg-gray-100 transition shadow-2xl border-4 border-red-700"
            >
              ♥ Get Started ♠
            </Link>
            <Link
              href="/how-to-play"
              className="bg-blue-900 text-white px-8 py-4 rounded-lg text-lg font-bold hover:bg-blue-950 transition border-4 border-white shadow-2xl"
            >
              ♦ Learn to Play ♣
            </Link>
          </div>

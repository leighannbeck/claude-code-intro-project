  ...
  return (
    <div className="bg-[#F2F2F2] min-h-screen py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        {/* Overview */}
        <div className="bg-white rounded-lg shadow-xl p-8 mb-6 border-4 border-[#243CBF]">
          <h2 className="text-3xl font-bold text-blue-900 mb-4 border-b-4 border-[#BF1736] pb-2">♠ Overview</h2>
        ...
        {/* The Deck */}
        <div className="bg-white rounded-lg shadow-xl p-8 mb-6 border-4 border-[#BF1736]">
          <h2 className="text-3xl font-bold text-red-900 mb-4 border-b-4 border-[#243CBF] pb-2">♥ The Deck</h2>
          ...
          <ul className="list-none text-gray-900 space-y-3 ml-4 text-lg font-medium">
            <li className="flex items-start"><span className="text-[#BF1736] mr-2">♦</span><span><span className="font-bold">4-player:</span> 2 decks (80 cards total)</span></li>
            <li className="flex items-start"><span className="text-[#243CBF] mr-2">♠</span><span><span className="font-bold">6-player:</span> 3 decks (120 cards total)</span></li>
            <li className="flex items-start"><span className="text-[#BF1736] mr-2">♥</span><span>Each deck contains two of each: 10, Jack, Queen, King, Ace (NO 9s)</span></li>
            <li className="flex items-start"><span className="text-[#A67D4B] mr-2">♣</span><span>In all four suits: Spades ♠, Hearts ♥, Diamonds ♦, Clubs ♣</span></li>
          </ul>
          <div className="mt-6 p-6 bg-blue-50 rounded-lg border-4 border-[#243CBF]">
            ...
            <p className="text-[#BF1736] font-bold mt-2 text-lg">Important: 10s are the SECOND highest cards, beating Kings!</p>
          </div>
        </div>

        {/* Game Variants */}
        <div className="bg-white rounded-lg shadow-xl p-8 mb-6 border-4 border-[#A67D4B]">
          <h2 className="text-3xl font-bold text-orange-900 mb-6 border-b-4 border-[#BF1736] pb-2">♣ Game Variants</h2>

          <div className="mb-8 bg-red-50 p-6 rounded-lg border-2 border-[#BF1736]">
            ...
            <ul className="list-none text-gray-900 space-y-2 ml-4 text-lg font-medium">
              <li className="flex items-start"><span className="text-[#BF1736] mr-2">•</span><span>Players sit across from their partner (Team 1 vs Team 2)</span></li>
              <li className="flex items-start"><span className="text-[#BF1736] mr-2">•</span><span>Each player receives 12 cards</span></li>
              <li className="flex items-start"><span className="text-[#BF1736] mr-2">•</span><span>Uses 2 decks (80 cards)</span></li>
              <li className="flex items-start"><span className="text-[#BF1736] mr-2">•</span><span>Teams work together to reach 500 points (default)</span></li>
            </ul>
          </div>

          <div className="bg-blue-50 p-6 rounded-lg border-2 border-[#243CBF]">
            <h3 className="text-2xl font-bold text-blue-900 mb-4 flex items-center">
              <span className="mr-2">♠</span> 6-Player Team Pinochle
            </h3>
            <ul className="list-none text-gray-900 space-y-2 ml-4 text-lg font-medium">
              <li className="flex items-start"><span className="text-[#243CBF] mr-2">•</span><span>Three teams of two players each</span></li>
              <li className="flex items-start"><span className="text-[#243CBF] mr-2">•</span><span>Each player receives 8 cards</span></li>
              <li className="flex items-start"><span className="text-[#243CBF] mr-2">•</span><span>Uses 3 decks (120 cards)</span></li>
              <li className="flex items-start"><span className="text-[#243CBF] mr-2">•</span><span>More complex bidding and strategy</span></li>
              <li className="flex items-start"><span className="text-[#243CBF] mr-2">•</span><span>Higher scoring potential</span></li>
            </ul>
          </div>
        </div>
        ...
        {/* Game Flow */}
        <div className="bg-white rounded-lg shadow-xl p-8 mb-6 border-4 border-[#243CBF]">
          <h2 className="text-3xl font-bold text-blue-900 mb-6 border-b-4 border-[#BF1736] pb-2">♦ Game Flow</h2>

          <div className="space-y-6">
            {/* Step 1 - Dealing */}
            <div className="bg-orange-50 p-6 rounded-lg border-l-8 border-[#A67D4B]">
              <h3 className="text-2xl font-bold text-orange-900 mb-3 flex items-center">
                <span className="bg-[#A67D4B] text-white rounded-full w-8 h-8 flex items-center justify-center mr-3 text-lg">1</span>
                Dealing
              </h3>
              <p className="text-gray-900 font-medium text-lg mb-3">
                The dealer rotates clockwise each round. Cards are dealt <span className="font-bold text-[#A67D4B]">4 at a time</span> to each player, starting to the left of the dealer (clockwise direction).
              </p>
              <ul className="list-none text-gray-900 space-y-2 ml-4 text-lg font-medium">
                <li className="flex items-start"><span className="text-[#A67D4B] mr-2">♣</span><span>4-player: Each player gets 12 cards</span></li>
                <li className="flex items-start"><span className="text-[#A67D4B] mr-2">♣</span><span>6-player: Each player gets 8 cards</span></li>
                <li className="flex items-start"><span className="text-[#A67D4B] mr-2">♣</span><span>Dealing proceeds clockwise, 4 cards at a time</span></li>
              </ul>
            </div>

            {/* Step 2 - Bidding */}
            <div className="bg-red-50 p-6 rounded-lg border-l-8 border-[#BF1736]">
              <h3 className="text-2xl font-bold text-red-900 mb-3 flex items-center">
                <span className="bg-[#BF1736] text-white rounded-full w-8 h-8 flex items-center justify-center mr-3 text-lg">2</span>
                Bidding
              </h3>
              <p className="text-gray-900 font-medium text-lg mb-3">
              ...
              <ul className="list-none text-gray-900 space-y-2 ml-4 text-lg font-medium">
                <li className="flex items-start"><span className="text-[#BF1736] mr-2">♥</span><span><span className="font-bold">Minimum bid: 50</span></span></li>
                <li className="flex items-start"><span className="text-[#BF1736] mr-2">♥</span><span>Bidding proceeds clockwise from the left of dealer</span></li>
                <li className="flex items-start"><span className="text-[#BF1736] mr-2">♥</span><span>Below 60: Can increase by any amount</span></li>
                <li className="flex items-start"><span className="text-[#BF1736] mr-2">♥</span><span>At 60 or above: Must increase by 5</span></li>
                <li className="flex items-start"><span className="text-[#BF1736] mr-2">♥</span><span>No maximum bid</span></li>
                <li className="flex items-start"><span className="text-[#BF1736] mr-2">♥</span><span>Once you pass, you cannot re-enter the bidding</span></li>
                <li className="flex items-start"><span className="text-[#BF1736] mr-2">♥</span><span className="font-bold text-[#BF1736]">CRITICAL: You must have at least one marriage (K+Q) to bid</span></li>
                <li className="flex items-start"><span className="text-[#BF1736] mr-2">♥</span><span>The highest bidder wins and names trump</span></li>
              </ul>
            ...
            <div className="bg-blue-50 p-6 rounded-lg border-l-8 border-[#243CBF]">
              <h3 className="text-2xl font-bold text-blue-900 mb-3 flex items-center">
                <span className="bg-[#243CBF] text-white rounded-full w-8 h-8 flex items-center justify-center mr-3 text-lg">3</span>
                Declaring Trump
              </h3>
              <p className="text-gray-900 font-medium text-lg mb-3">
                The winning bidder declares the trump suit.
              </p>
              <div className="p-4 bg-red-100 rounded-lg border-4 border-[#BF1736]">
            ...
            <div className="bg-orange-50 p-6 rounded-lg border-l-8 border-[#A67D4B]">
              <h3 className="text-2xl font-bold text-orange-900 mb-3 flex items-center">
                <span className="bg-[#A67D4B] text-white rounded-full w-8 h-8 flex items-center justify-center mr-3 text-lg">6</span>
                Scoring
              </h3>
              <p className="text-gray-900 font-medium text-lg mb-3">
              ...
              <ul className="list-none text-gray-900 space-y-2 ml-4 text-lg font-medium">
                <li className="flex items-start"><span className="text-[#A67D4B] mr-2">♣</span><span>If bidding team&apos;s total ≥ bid: They score their points, opponents score their points</span></li>
                <li className="flex items-start"><span className="text-[#BF1736] mr-2">♥</span><span className="font-bold text-[#BF1736]">If bidding team&apos;s total &lt; bid: They go &quot;set&quot; (NEGATIVE bid amount)</span></li>
                <li className="flex items-start"><span className="text-[#A67D4B] mr-2">♣</span><span>Opponents always score their points regardless</span></li>
                <li className="flex items-start"><span className="text-[#A67D4B] mr-2">♣</span><span>No penalty for exceeding the bid</span></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        {/* Meld Scoring */}
        <div className="bg-white rounded-lg shadow-xl p-8 mb-6 border-4 border-[#BF1736]">
          <h2 className="text-3xl font-bold text-red-900 mb-6 border-b-4 border-[#243CBF] pb-2">♥ Meld Scoring</h2>

          <div className="overflow-x-auto">
            <table className="w-full text-left border-4 border-gray-300">
              <thead className="bg-gradient-to-r from-[#BF1736] to-[#243CBF] text-white">
                <tr>
              ...
              <tbody className="divide-y-2 divide-gray-300 font-medium text-gray-900">
                ...
                <tr className="bg-orange-50">
                  ...
                  <td className="px-4 py-3 font-bold text-orange-700 text-xl">90</td>
                </tr>
                <tr className="bg-red-50">
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg border-4 border-[#243CBF]">
            <p className="text-gray-900 font-medium text-lg">
        ...
        {/* Trick Points */}
        <div className="bg-white rounded-lg shadow-xl p-8 mb-6 border-4 border-[#A67D4B]">
          <h2 className="text-3xl font-bold text-orange-900 mb-6 border-b-4 border-[#BF1736] pb-2">♣ Trick Points</h2>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-4 border-gray-300">
              <thead className="bg-gradient-to-r from-[#A67D4B] to-[#243CBF] text-white">
                <tr>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg border-4 border-[#243CBF]">
            ...
            <ul className="text-gray-900 font-medium space-y-1 text-lg">
              <li className="flex items-start"><span className="text-[#BF1736] mr-2">♦</span><span>4-player: 26 points (8 Aces + 8 Tens + 8 Kings + 2 last trick)</span></li>
              <li className="flex items-start"><span className="text-[#243CBF] mr-2">♠</span><span>6-player: 39 points (12 Aces + 12 Tens + 12 Kings + 3 last trick)</span></li>
            </ul>
          </div>
        </div>
        ...
        {/* Winning the Game */}
        <div className="bg-white rounded-lg shadow-xl p-8 mb-6 border-4 border-[#243CBF]">
          <h2 className="text-3xl font-bold text-blue-900 mb-6 border-b-4 border-[#BF1736] pb-2">🏆 Winning the Game</h2>
        ...
        {/* Strategy Tips */}
        <div className="bg-white rounded-lg shadow-xl p-8 border-4 border-[#BF1736]">
          <h2 className="text-3xl font-bold text-red-900 mb-6 border-b-4 border-[#243CBF] pb-2">💡 Strategy Tips</h2>
          <ul className="list-none text-gray-900 space-y-3 text-lg font-medium">
            <li className="flex items-start"><span className="text-[#BF1736] mr-2">♥</span><span>Count your meld points before bidding to estimate your total potential</span></li>
            <li className="flex items-start"><span className="text-[#243CBF] mr-2">♠</span><span>Must have at least one marriage (K+Q) to bid - check this first!</span></li>
            <li className="flex items-start"><span className="text-[#BF1736] mr-2">♦</span><span>Can only call trump in suits where you have K+Q</span></li>
            <li className="flex items-start"><span className="text-[#243CBF] mr-2">♠</span><span>Remember that 10s are the second highest cards - they beat Kings!</span></li>
            <li className="flex items-start"><span className="text-[#A67D4B] mr-2">♣</span><span>Remember your partner can help - their meld contributes too</span></li>
            <li className="flex items-start"><span className="text-[#BF1736] mr-2">♥</span><span>Trump cards are powerful - use them strategically</span></li>
            <li className="flex items-start"><span className="text-[#243CBF] mr-2">♠</span><span>You must beat if you can - no choice even if it beats your partner</span></li>
            <li className="flex items-start"><span className="text-[#BF1736] mr-2">♦</span><span>Keep track of which cards have been played</span></li>
            <li className="flex items-start"><span className="text-[#A67D4B] mr-2">♣</span><span>Don&apos;t be afraid to pass if your hand is weak or you lack marriages</span></li>
            <li className="flex items-start"><span className="text-[#243CBF] mr-2">♠</span><span>The last trick bonus is significant (2-3 points)</span></li>
          </ul>
        </div>
      </div>
    </div>
